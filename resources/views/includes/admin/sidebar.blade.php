            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.post-categories.index') }}" class="nav-link {{ (request()->segment(2) == 'post-categories') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kategori Berita</p>
                            </a>
                        </li>
                ...
                @if(Auth::user()->role == 0)
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.complaints.index') }}" class="nav-link {{ (request()->segment(2) == 'complaints') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Data Pengaduan</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.complaint-categories.index') }}" class="nav-link {{ (request()->segment(2) == 'complaint-categories') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
