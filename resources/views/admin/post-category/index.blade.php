            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header d-flex justify-content-end">
                        <a href="{{ route('admin.post-categories.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add Category</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            @forelse($categories as $key => $cat)
                                <tr>
                                    ...
                                    <td>{{ $cat->name }}</td>
                                    <td class="d-flex">
                                        <a href="{{ route('admin.post-categories.edit', $cat->id) }}" class="btn btn-warning mr-2" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.post-categories.destroy', $cat->id) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
